  ...
  var tasks = {
    "tasks": [
      ...
      },
      {
        ...
        "example": "validate_pin('1234') == True <br> validate_pin('12345') == False <br> validate_pin('a234') == False",
      ...
      },
      {
        ...
        "example": "remove_smallest([1,2,3,4,5]) = [2,3,4,5] <br> remove_smallest([5,3,2,1,4]) = [5,3,2,4] <br> remove_smallest([2,2,1,2,1]) = [2,2,2,1]",
      ...
      },
      {
        ...
        "example": "Ввод: \"is2 Thi1s T4est 3a\" Вывод: \"Thi1s is2 3a T4est\"",
      ...
      },
      {
        ...
        "example": "[34, 15, 88, 2] == 2 <br> [34, -345, -1, 100] == -345",
      ...
      },
      {
        ...
        "example": "longest_consec(['zone', 'abigail', 'theta', 'form', 'libe', 'zas', 'theta'], 2) == 'abigailtheta'",
      ...
      },
      {
        ...
        "example": "find_needle(['hay', 'junk', 'hay', 'hay', 'moreJunk', 'needle', 'randomJunk']) == 5",
      ...
      },
      {
        ...
        "example": "accum('abcd') == 'A-Bb-Ccc-Dddd' <br> accum('RqaEzty') == 'R-Qq-Aaa-Eeee-Zzzzzz-Tttttt-Yyyyyyy' <br> accum('cwAt') == 'C-Ww-Aaa-Tttt'",
      ...
      },
      {
        ...
        "example": "{1,2,3,4,3,2,1} == 3 // 1 + 2 + 3 = 3 + 2 + 1 <br> {1,100,50,-51,1,1} == 1 // 1 = 50 + (-51) + 1 + 1",
      ...
      },
      {
        ...
        "example": "song_decoder('WUB<u>WE</u>WUB<u>ARE</u>WUBWUB<u>THE</u>WUB<u>CHAMPIONS</u>WUB<u>MY</u>WUBWUBWUB<u>FRIEND</u>WUB') == 'WE ARE THE CHAMPIONS MY FRIEND'",
      ...
      },
      {
        ...
        "example": "row_sum_odd_numbers(1) == 1 <br> row_sum_odd_numbers(2) == 8",
      ...
      },
      {
        ...
        "example": "h = 3, bounce = 0.66, window = 1.5, результат = 3 <br>h = 3, bounce = 1, window = 1.5, результат = -1",
      ...
      },
      {
        ...
        "example": "DNA_strand ('ATTGC') = 'TAACG' <br> DNA_strand ('GTAT') = 'CATA'",
      ...
      {W
        ...
        "example": "'abcde' == 0 // повторяющиеся символы отсутствуют<br>'aabbcde' == 2 // 'a' и 'b'<br>'aabBcde' == 2 // 'a' и 'b' (заглавная b учитывается) <br>'indivisibility' == 1 // 'i' встречается шесть раз <br>'Indivisibilities' == 2 	// 'i' встречается семь раз, а 's' — дважды <br>'aA11' == 2 // 'a' и '1' <br>'ABBA' == 2 // 'A' и 'B' по два раза",
      ...
      },
      {
        ...
        "example": "unique_in_order('AAAABBBCCDAABBB') == ['A', 'B', 'C', 'D', 'A', 'B']<br>unique_in_order('ABBCcAD') == ['A', 'B', 'C', 'c', 'A', 'D']<br>unique_in_order([1,2,2,3,3]) == [1,2,3]",
      ...
      },
      {
        ...
        "example": "sort_array([<b>5</b>, <b>3</b>, 2, 8, <b>1</b>, 4]) == [1, 3, 2, 8, 5, 4]",
      ...
      },
      {
        ...
        "example": "SeriesSum(1) == 1 == 1.00 <br>SeriesSum(2) == 1 + 1/4 == 1.25 <br>SeriesSum(5) == 1 + 1/4 + 1/7 + 1/10 + 1/13 == 1.57",
      ...
      },
      {
        ...
        "example": "nb_dig(10, 1) == 4 <br>// Так как для чисел 0, 1, 4, 9, 16, 25, 36, 49, 64, 81, 100 мы используем цифру 1 в записи 1, 16, 81, 100<br><br>nb_dig(25, 1) == 11 <br>// 1, 4, 9, 10, 11, 12, 13, 14, 19, 21 при возведении в квадрат дают 1, 16, 81, 100, 121, 144, 169, 196, 361, 441",
      ...
      },
      {
        ...
        "example": "array_diff([1,2],[1]) == [2]<br>array_diff([1,2,2,2,3],[2]) == [1,3]",
      ...
      },
      {
        ...
        "example": "reverse('Hello World') == 'World Hello'<br>reverse('Hi There.') == 'There. Hi'",
      ...
      },
      {
        ...
        "example": "'This is an example!' == 'sihT si na !elpmaxe' <br>'double  spaces' == 'elbuod  secaps'",
      ...
      },
      {
        ...
        "example": "sequenceSum(2,2,2) === 2 <br>sequenceSum(2,6,2) === 12 // 2 + 4 + 6 <br>sequenceSum(1,5,1) === 15 // 1 + 2 + 3 + 4 + 5 <br>sequenceSum(1,5,3) === 5 // 1 + 4",
      ...
      },
      {
        ...
        "example": "delete_nth([1,1,1,1],2) == [1,1]<br>delete_nth([20,37,20,21],1) == [20,37,21]",
